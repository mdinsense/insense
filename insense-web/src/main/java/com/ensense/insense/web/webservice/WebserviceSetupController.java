package com.ensense.insense.web.webservice;

import com.ensense.insense.core.webservice.model.SuiteObj;
import com.ensense.insense.core.webservice.model.WSBaselineDate;
import com.ensense.insense.core.webservice.model.WSSuiteParams;
import com.ensense.insense.core.webservice.model.WebServiceReports;
import com.ensense.insense.core.webservice.util.RestServiceUtil;
import com.ensense.insense.core.webservice.util.WebserviceUtil;
...
public class WebserviceSetupController {
	...
	public String WebserviceSetupGet(Model model) {
		...
		logger.debug("Exit: WebserviceSetupGet, webserviceSetupForm->"
				+ webserviceSetupForm);
		return Constants.WebserviceTestingAdmin.VIEW;
	}
	...
	public String WebserviceTestingSetupGet(Model model) {
		...
		logger.debug("Exit: WebserviceTestingSetup, webserviceSetupForm->"
				+ webserviceSetupForm);
		return Constants.WebserviceTest.VIEW;
	}
	...
	/*		case 5:
		...
		return Constants.WebserviceTestingAdmin.REDIRECT_VIEW;
	}
	...
	public String WebserviceTestingSetup(
		...
		logger.debug("Exit: uiTestingSetup");
		redirAttr.addFlashAttribute("webserviceSetupForm", webserviceSetupForm);
		return Constants.WebserviceTest.REDIRECT_VIEW;
	}
	...
	public String addWebservices(RedirectAttributes redirAttr,
		...
		try {
			...
			webserviceSetupForm
			.setSetupTabNumber(Constants.WebserviceTestingAdmin.ADD_WEBSERVICE);
	...
	public String saveRawInputs(RedirectAttributes redirAttr,
		...
		try {
			webserviceSetupForm.setSetupTabNumber(Constants.WebserviceTest.CREATE_DATASET);
	...
	public String submitWSTestCases(RedirectAttributes redirAttr,
			Model model, @ModelAttribute WebserviceSetupForm webserviceSetupForm, BindingResult results) {
	...
	public String updateSelectedServices(RedirectAttributes redirAttr,
		...
		try {
			webserviceSetupForm.setSetupTabNumber(Constants.WebserviceTestingAdmin.RELOAD_WEBSERVICES);
	...
	*/
	...
	public String wsReportsRetrieve(RedirectAttributes redirAttr,
		...
		try {
			...
			int environmentId = webserviceSetupForm.getEnvironmentId();
			webserviceSetupForm.setSetupTabNumber(Constants.WebserviceTestingAdmin.WEBSERVICE_REPORTS);
