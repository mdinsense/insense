...
public class PublicInstituteLogin extends TestCase{
  ...
  @Test
  public void testPublicInstituteLogin() throws Exception {
    driver.get(baseUrl + "/cs/ContentServer?d=&pagename=TCPublic%2FSetDomainNameInCookie");
    new Select(driver.findElement(By.name("domainName"))).selectByVisibleText("Institute");
