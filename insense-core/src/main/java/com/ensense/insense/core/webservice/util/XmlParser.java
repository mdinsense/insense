...
public class XmlParser {
    ...
    public Map generateMap(String xmlString) {
        ...
        xmlMap = getParams(xmlMap, 0, resultMap);
		return xmlMap;
    }
    ...
    private static Map<String, String> getParams(Map map, Integer tab, Map<String, String> resultXML) {
         ...
         while (it.hasNext()) {
             ...
             if (value instanceof Map) {
                 System.out.println(getTab(tab) + key + " ==> [");
                 getParams((Map) value, tab + 1, resultXML);
                 System.out.println(getTab(tab) + "]");
             }
             else if (value instanceof List) {
                 System.out.println(getTab(tab) + key + " ==> [");
                 getParams((List) value, tab + 1, resultXML);
                 System.out.println(getTab(tab) + "]");
             }
             else {
                 System.out.println(getTab(tab) + key + " ==> " + value);
                 resultXML.put(key.toString(), value.toString());
    ...
    private static void getParams(List list, Integer tab, Map<String, String> resultXML) {
